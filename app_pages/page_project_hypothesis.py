...
def page_project_hypothesis_body():
    ...
    st.success(
        ...
        "reliably distinguish between healthy and infected leaves.\n"
        "2. We hypothesise that we can reach the minimum accuracy of 97% set by "
        "the client. Although this is a high threshold, we believe that the "
        "model can meet or exceed this target using the dataset of four "
        "thousand images provided by the client.\n"
    ...
    st.warning(
        ...
        "2. The model achieved an accuracy of 99%, surpassing the predefined client "
        ...
        "could see in the average images we produced.\n"
        ...
        "In conclusion, the machine learning model successfully achieved 99% "
